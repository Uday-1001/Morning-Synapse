...
class SiteScraper:
    ...
    def get_articles(self, hours: int = 24) -> List[SiteArticle]:
...
class TechCrunchScraper(SiteScraper):
    def __init__(self):
        super().__init__(["https://techcrunch.com/category/artificial-intelligence/feed/"])


class VentureBeatScraper(SiteScraper):
    def __init__(self):
        super().__init__([
...
TechCrunchArticle = SiteArticle
VentureBeatArticle = SiteArticle
